    ...
    >
      <div className="w-[80%] max-lg:w-[85%] grid grid-cols-[1.5fr_1fr] max-[900px]:grid-cols-1 pb-15 max-sm:pb-8 gap-20 max-[900px]:gap-5">
        <div className="text-[var(--text-dark)] max-[900px]:order-2 max-[900px]:text-center">
          <h1 className="text-[40px] max-sm:text-3xl max-[370px]:text-2xl! max-lg:text-3xl font-bold leading-14 max-lg:leading-10 max-[900px]:leading-8 text-[var(--text-dark)]! max-[900px]:hidden">
            Mohamed Maimoune
          </h1>
          <h3 className="text-2xl max-sm:text-xl max-[370px]:text-lg! max-lg:text-2xl font-semibold max-[900px]:hidden">
            {t("Full Stack Developer")}
          </h3>
          <p className="mt-5 max-sm:text-sm">{t("bio")}</p>
        ...
        <span className="min-[900px]:hidden! flexy flex-col">
          <h1 className="text-[40px] max-sm:text-3xl max-[370px]:text-2xl! max-lg:text-3xl font-bold leading-14 max-lg:leading-10 max-[900px]:leading-8 text-[var(--text-dark)]!">
            Mohamed Maimoune
          </h1>
          <h3 className="text-2xl max-sm:text-xl max-[370px]:text-lg! max-lg:text-2xl font-semibold">
            {t("Full Stack Developer")}
          </h3>
        </span>
